<div class="container-fluid">
	...
	<div class="d-inline-flex flex-column align-items-center justify-content-between mb-4">
		...
		<button type="button" class="mt-4 d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#modalAddMenu"><i class="fa fa-plus-circle text-white-50"></i> Tambah Menu</button>
	</div>
									...
									foreach ($menu as $key) { ?>
										<tr>
											...
											<td>
												...
												<a class="badge badge-danger mt-1" href="<?= base_url('administrator/'); ?>deletemenu/<?= $key['menu_id'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')">
...
<div class="modal fade" id="modalAddMenu" tabindex="-1" role="dialog" aria-labelledby="titleAddMenu" aria-hidden="false">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<?= form_open('administrator/addmenu'); ?>
	...
	<div class="modal fade" id="editMenu<?= $key['menu_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="editMenu" aria-hidden="false">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<?= form_open('administrator/allmenu') ?>
				<div class="modal-body">
